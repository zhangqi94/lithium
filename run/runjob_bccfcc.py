...
list_temperature = [140, 150, 160, 170, 180, 190, 200, 210, 220]

for ii in range(len(list_temperature)):
    #========== lattice ==========
    target_pressure = "-1"
    ...
    # lattice_type, supercell_size = "fcc", "4 4 4"
    # volume_per_atom = "19.542997"
    
    lattice_type, supercell_size = "bcc", "5 5 5"
    volume_per_atom = "19.515776"
    
    temperature = str(list_temperature[ii])

    #========== batch ==========
    # batch, acc_steps = "1024", "1"
    # batch, acc_steps = "512", "1"
    batch, acc_steps = "400", "1"
    ...
    relax_steps = "50"
    relax_decay = "0.99"
    relax_begin = "1000" # cell relaxation after xxx epochs
    relax_therm = "5"
    num_recent_vals = "20"
    ...
    folder = "/data/zhangqidata/lithium/dp4trans_npt_press2_train/"
    ...
    job_name = (
        f"train_{isotope}_{dptype}_{lattice_type}_t{temperature}"
